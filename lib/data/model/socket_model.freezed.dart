...
class _$SocketModelImpl implements _SocketModel {
  ...
  @override
  String toString() {
    return 'SocketModel(id: $id, channel: $channel, message_to: $message_to, message_from: $message_from, message: $message, data: $data)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, channel, message_to,
